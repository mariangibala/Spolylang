...
//-----------------------------------------------------
    ...
    var animateMessage = function () {
      ...
      el.velocity({opacity: 1, top: topPosition}, {
        delay: 50,
        display: "block",
        duration: 350,
        easing: "easeOutQuart",
...
//-----------------------------------------------------
    ...
    var resetAnimation = function (animationTime) {
      ...
      timerScale.velocity("stop").css("width", windowWidth)
        .velocity({width: 0}, animationTime);
